...
func (ur *UserRepository) FindAll() ([]*model.UserModel, error) {
	var userModel []*model.UserModel
	var userModelOut []*model.UserModel
...
func (ur *UserRepository) FindByUserEmail(email string) (*model.UserModel, error) {
	var userModel *model.UserModel
...
func (ur *UserRepository) UpdateByEmail(input *model.UserModel) (*model.UserModel, error) {
